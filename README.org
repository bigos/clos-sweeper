...
While you can download the zipped folder it refuses to run from the Windows File Manager.
[[https://github.com/bigos/clos-sweeper/raw/master/distribution.zip][zipped Windows distribution folder]]
